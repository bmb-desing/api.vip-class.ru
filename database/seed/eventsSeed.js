...
const events = [
	{
		...
		image: '/img/events/event-voenaya-ipoteka.jpg',
	...
	},
	{
		...
		image: '/img/events/event-matkapital.jpg',
	...
	{
		title: 'Скидка ветеранам войны',
		alias: 'skidka-veteranam-vojny',
		shortText: 'Компания «VIP CLASS» предоставляет скидку ветеранам войны',
		description: 'Приобретение квартиры ветеранам войны со скидкой',
		image: '/img/events/event-veteran.jpg',
		link: 'Вы ветеран войны? <b>Получите скидку</b>',
		text: '<p>С каждого квадратного метра, приобретаемого в нашем ЖК\n' +
		'«Жемчужина Севастополя»</p>' +
		'<p>Ветераны войны получают <b>скидку</b>!</p>'
	}
]
